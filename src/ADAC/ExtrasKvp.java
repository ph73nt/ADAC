...
public class ExtrasKvp extends ADACKvp {
	...
	public static final String MODALITY_DESC = "Modality";
	public static final String MODALITY_KEY = "WLAB";
	...
	private void makeMap(byte[] bytes) {
		...
		for (int i = 0; i < tokens.length; i++) {
			...
			String key = tok.substring(0, 4);
			String value = tok.substring(5);
